...
**See also:** [GOVERNANCE.md](GOVERNANCE.md) — the proposal process these ballots sit inside · [COMMUNICATIONS.md](COMMUNICATIONS.md) — where discussion becomes record · [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md) — how disagreement is conducted
