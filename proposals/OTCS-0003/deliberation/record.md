...
| One external architecture with heavy Layer 3 and thin Evidence | **Drafted** on NeMo Guardrails, chosen for being open source and documented ([nemo-guardrails.md](../../../calibration/nemo-guardrails.md)). 5 of 5 under the split. **Subject to the founder's confirmation of the subject** |
...
## The four open questions, answered for the record *(founder's answers pending; drafted answers below)*
