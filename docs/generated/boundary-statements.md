!!! info "Generated page"
    Compiled from `BOUNDARY-STATEMENTS.md` by `npm run generate:docs`. Edit the source, not this file. The repository is the record; this page is a rendering of it.
