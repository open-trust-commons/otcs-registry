!!! info "Generated page"
    Compiled from `COMMUNICATIONS.md` by `npm run generate:docs`. Edit the source, not this file. The repository is the record; this page is a rendering of it.
...
**See also:** [GOVERNANCE.md](governance.md) §14 — the same rule, stated as governance · [SECURITY.md](security.md) §5 — how to report a vulnerability · [CODE_OF_CONDUCT.md](code-of-conduct.md) — conduct in every plane
